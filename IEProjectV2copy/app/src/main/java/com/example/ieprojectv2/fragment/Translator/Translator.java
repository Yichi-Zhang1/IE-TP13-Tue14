package com.example.ieprojectv2.fragment.Translator;
...
public class Translator extends Fragment {
    ...
    private TranslatorViewModel mViewModel;
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = ViewModelProviders.of(this).get(TranslatorViewModel.class);
